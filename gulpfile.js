...
// the arguments for autoprefixer
var autoPrefixList = ['last 2 versions', 'safari 5', 'ie 9', 'opera 12.1', 'ios 6', 'android 4'];
...
function images() {
	...
	.pipe(plugins.imagemin(imgOptions,{verbose: true}))
